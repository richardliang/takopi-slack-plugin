...
def default_upload_name(filename: str | None, fallback: str | None) -> str:
...
def default_upload_path(
    uploads_dir: str, filename: str | None, fallback: str | None
) -> Path:
    return Path(uploads_dir) / default_upload_name(filename, fallback)
